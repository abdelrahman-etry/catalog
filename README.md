...
``` sudo service apache2 restart ```
# References.
See [Amazon Lightsail WebsiteAmazon Lightsail Website](https://aws.amazon.com/lightsail/?p=tile)
See [Udacity](https://www.udacity.com/)
See [Apache](https://httpd.apache.org/docs/2.2/configuring.html)
see [Ask Ubuntu](https://askubuntu.com/)
# End
