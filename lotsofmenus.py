...
menuItem3 = MenuItem(
    ...
    description='''Seared rare ahi, avocado, edamame, cucumber with wasabi
                soy sauce ''',
    price='15',
    course='Entree',
    restaurant=restaurant2,
...
menuItem2 = MenuItem(
    ...
    minced meat and finely chopped vegetables wrapped into a piece of
    dough skin. The skin can be either thin and elastic or thicker.''',
    price='$6.99',
    course='Appetizer',
    restaurant=restaurant1,
    )
...
menuItem5 = MenuItem(
    ...
    description='''Vegan goodness. Burrito filled with rice, garbanzo beans,
                curry sauce, potatoes (aloo), fried cauliflower (gobi) and
                chutney. Nom Nom''',
    price='$7.95',
    course='Entree',
    restaurant=restaurant1,
...
menuItem1 = MenuItem(
    ...
    description='''Lobster, shrimp, sea snails, crawfish, stacked into
                a delicious tower''',
    price='$13.95',
    course='Entree',
    restaurant=restaurant1,
